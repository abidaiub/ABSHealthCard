...
namespace ABShealthcard.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("ABShealthcard") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "ABShealthcard", DisplayName = "ABShealthcard API", Resources = { "ABShealthcard" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Blazor Client
        var blazorClientId = configurationSection["ABShealthcard_Blazor:ClientId"];
        if (!blazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["ABShealthcard_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["ABShealthcard_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["ABShealthcard_Swagger:RootUrl"]?.TrimEnd('/');
